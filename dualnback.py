...
while True:
    ...
    if game_active: # playing a level
        DISPLAYSURF.blit(grid_top_left, (170,80))
        DISPLAYSURF.blit(grid_top_center, (330,80))
        DISPLAYSURF.blit(grid_top_right, (490,80))
        DISPLAYSURF.blit(grid_mid_left, (170,240))
        DISPLAYSURF.blit(grid_mid_center, (330,240))
        DISPLAYSURF.blit(grid_mid_right, (490,240))
        DISPLAYSURF.blit(grid_bot_left, (170,400))
        DISPLAYSURF.blit(grid_bot_center, (330,400))
        DISPLAYSURF.blit(grid_bot_right, (490,400))
